...
function agregarStringInvertida() {
   ...
   String.prototype.reverse =function(){
      var palabraSeparadaInvertida =[]
      var palabraSeparada = this.split("");

      for(var i= palabraSeparada.length -1 ; i >= 0 ; i--){
         palabraSeparadaInvertida.push(palabraSeparada[i])
      }
      palabraArreglada = palabraSeparadaInvertida.join("");
